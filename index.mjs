...
const n = document.getElementsByClassName("phone").value;

let a1 = airtelLine1a(('' + airtelLine1), 11);

 function validateServiceProvider() {
  if (airtelLine1.has(n) == true) {
    var airtelElement = document.getElementsByClassName("airtelLogo");
    return document.getElementById("imgid").remove(airtelElement);
  }
}
...
document.getElementById("myBtn").addEventListener("submit", validateServiceProvider());
